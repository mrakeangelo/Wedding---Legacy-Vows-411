...
const Gallery = () => {
  ...
  const galleryImages = [
    {
      ...
      alt: "Our first family photo together",
      category: "family"
    },
    {
    ...
    },
    {
      ...
      alt: "Sarah with her children",
      category: "memories"
    },
    {
      src: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      alt: "Michael with his daughters",
      category: "memories"
    },
    {
    ...
    },
    {
      ...
      alt: "Building our home together",
      category: "family"
    }
  ];
  ...
  return (
    <section id="gallery" className="section-spacing bg-pearl-white dark:bg-deep-slate">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-warm-gray dark:text-champagne max-w-2xl mx-auto leading-relaxed">
            From our individual journeys to our life together, these moments capture 
            the beauty of second chances and the joy of blended families.
          </p>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 text-center">
                <p className="text-white font-medium bg-black/50 backdrop-blur-sm rounded-lg px-4 py-2">
                  {selectedImage.alt}
                </p>
              </div>
            </motion.div>
